...
"""
-------------------------------------------------
Project Name: yolov5-mask_detection
...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/MASK.jpg"))
        # 图片读取进程
        ...
        self.model = self.model_load(weights="runs/train/exp_self/weights/best.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.setTabIcon(0, QIcon('images/UI/MASK.jpg'))
        self.setTabIcon(1, QIcon('images/UI/MASK.jpg'))
        self.setTabIcon(2, QIcon('images/UI/MASK.jpg'))
